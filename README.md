...
- [ ] Install Oculus Rift Runtime 1.8.0 https://www.oculus.com/en-us/setup/
- [ ] ``pip install ovr``
...
## Details
Runs on Windows only at the moment, but so does OVR SDK 1.8.0

This python module uses the installed 32-bit OVR dll on Windows, so you must have the Oculus 1.8 Runtime installed to use this module. Get the Oculus Runtime at https://www.oculus.com/en-us/setup/
